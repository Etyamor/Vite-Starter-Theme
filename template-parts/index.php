...
<main class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4">
	<div class="mx-auto max-w-6xl">
		...
		<?php get_template_part( 'template-parts/welcome/install' ); ?>
		<?php get_template_part( 'template-parts/welcome/guide' ); ?>
		<?php get_template_part( 'template-parts/welcome/development' ); ?>
		<?php get_template_part( 'template-parts/welcome/structure' ); ?>
		<?php get_template_part( 'template-parts/welcome/tips' ); ?>
		<?php get_template_part( 'template-parts/welcome/bundling' ); ?>
